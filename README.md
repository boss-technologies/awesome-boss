...
> 🧪 **Текущая версия: 0.4 ** –  ядро готово, BAT, Boss Socket, `boss.toml` готов, аудит и DDoS-защита готовы, проведены доработки, BossQ, Decimal, HTTP/2 - следующие версии добавят ещё больше нового**
...
- 🧩 **Плагины** – Позволяют расширять функционал без изменения ядра на основе интерфейсов. Будут в 0.5
...
> 👉 **Сейчас версия 0.4**: - – ядро готово, BAT, Boss Socket, `boss.toml` готов, аудит и DDoS-защита готовы, проведены доработки, BossQ, Decimal, HTTP/2 - следующие версии добавят ещё больше нового
