...
> 🧪 **Текущая версия: 0.3 ** – ядро готово, BAT, Boss Socket, `boss.toml` готов, аудит и DDoS-защита готовы, проведены доработки - следующие версии добавят ещё больше**
...
- 🏦 **Два режима**: `normal` (быстрый старт) и `fintech` (Decimal (будет в 0.4), аудит, DDoS-защита)
- 🧩 **Плагины** – будут в 0.5
...
> 👉 **Сейчас версия 0.3**: - – ядро готово, BAT, Boss Socket, `boss.toml` готов, аудит и DDoS-защита готовы, проведены доработки - следующие версии добавят ещё больше нового
